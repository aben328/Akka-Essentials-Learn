...
/**
 * Let's start with the  MapActor class whose responsibility was to take in the English
 * sentence as a  String object, identify the words in the sentence, and not count the
 * STOP words .Once finished, MapActor will send the mapped data list to the Master
 * actor, who will send it to Reduce actor:
...
public class MapActor extends UntypedActor {
    ...
    public void onReceive(Object message) throws Throwable {
        if (message instanceof String) {
            ...
            //map the words in the sentence and send the result to Master\Actor
